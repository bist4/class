    ...
    if (isset($_GET['subid']) && !empty($_GET['subid'])) {
        ...
        if ($resultsection) {
            ...
            if (empty($allSectionData)) {
                echo "No subjects found for the provided IDs";
            }
        } else {
...
<head>
    ...
    <title>Edit Subject - File Maintenance</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <h6 class="d-inline-block active" id="viewStrand">Edit Subject</h6>
                            ...
                            <form id="updateForm">
                                <div class="table-responsive">
                                    <table class="table table-hover small-text" id="tb">
                                        <tr class="tr-header">
                                            <th><label class="form-check-label" for="hideSubjectCode">Subject Code</label></th>
                                            <th><label class="form-check-label" for="hideSubjectName">Subject Name</label></th>
                                            <!-- <th><label class="form-check-label" for="hideSubjectName">Classification</label></th> -->
                                            <th><label class="form-check-label" for="hideSubjectName">Type</label></th>
                                            <th><label class="form-check-label" for="hideHours">Minutes Per Week</label></th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-md-2">
                                                    <select class="form-control" id="subType<?php echo $secdata['SubjectID']; ?>"" name="Type[]" required>
                                                        ...
                                                        <option value="N/A" <?php if ($secdata['Type'] === 'N/A') echo 'selected'; ?>>N/A</option>
                                                        <option value="Core" <?php if ($secdata['Type'] === 'Core') echo 'selected'; ?>>Core</option>
                                                        <option value="Applied" <?php if ($secdata['Type'] === 'Applied') echo 'selected'; ?>>Applied</option>
                                                        <option value="Specialized" <?php if ($secdata['Type'] === 'Specialized') echo 'selected'; ?>>Specialized</option>
                                                    </select>
                                                </td>
                                                    
                                                <td class="col-md-2">
                                                    <input type="number" min="30" max="500" class="form-control" id="MinutesPerWeek_<?php echo $secdata['SubjectID']; ?>" value="<?php echo $secdata['MinutesPerWeek']; ?>" name="MinutesPerWeek[]" placeholder="Enter Hours" title="Input Hours">
                                                    <input type="hidden" name="SubjectID[]" value="<?php echo $secdata['SubjectID']; ?>">
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </table>
