...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateSql = "UPDATE classschedule SET Active = 2 WHERE YearLevel = '$yearLevel' AND Semester = '$semester' AND Strand = '$strand' AND Section = '$section' AND Active = 0";
    ...
    if ($conn->query($updateSql) === TRUE) {
        ...
        $insertMessageSql = "INSERT INTO message (CreatedAt, UserFrom, UserTo, YearLevel, Section, Action, Strand) 
                             VALUES (NOW(), $fromUser, $toUser, '$yearLevel', '$section', 2, '$strand')";
