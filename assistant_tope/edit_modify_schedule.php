                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="button" id="cancelBtn" onclick="location.href='modify_schedule.php';" class="btn btn-outline-secondary mr-2">Cancel</button> 
...
<!-- <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        formElements.forEach(function(element) {
            element.addEventListener('change', setChangesMade);
        });
    });
