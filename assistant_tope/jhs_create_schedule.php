...
<html lang="en">
    ...
    <head>
        ...
        <title>Create schedule for junior high school</title>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseSchedule" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="jhs_create_schedule.php">Junior High School</a>
                        ...
                        <div class="container mt-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h1 style="font-size: 25px;">Create Junior High School Schedule</h1>
                                </div>
                            </div>
                            <div class="row mb-4">
        ...
        <td>
            ...
            <td>
                <select class="form-control Instructor" id="instructor" name="Instructor[]" required>
                    ...
                    $sqlInstructors = "SELECT * FROM instructor WHERE DepartmentID = 2 AND Active = 1";
            ...
            <td>
                <select class="form-control Room" id="room" name="Room[]" required>
                    ...
                    <?php
                    require('../config/db_connection.php');
                    $sqlRooms = "SELECT * FROM rooms WHERE DepartmentID = 2 AND Active = 1";
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#yearLevel').change(function () {
                ...
                $.ajax({
                    url: 'GetData/jhs_get_year_level_section.php', // Replace with the actual PHP script URL
                ...
                $.ajax({
                    url: 'GetData/jhs_get_year_level_subject.php', // Replace with the actual PHP script URL
                    method: 'POST', // Use POST or GET depending on your PHP script
                    data: { yearLevel: yearLevel }, // Use 'track' here
                    success: function (data) {
                        // Update the 'strand' dropdown with the fetched data
...
function saveSchedule() {
    ...
    // Check if any subject exceeds 240 minutes per week (4 hours)
    // var exceedSubjects = Object.keys(subjectMinutes).filter(function (subject) {
    //     return subjectMinutes[subject] > 240; // 240 minutes per week (4 hours)
    // });

    // if (exceedSubjects.length > 0) {
    //     // Display a warning for subjects exceeding 240 minutes per week
    //     var exceedSubjectNames = exceedSubjects.join(', ');
    //     Swal.fire({
    //         icon: 'warning',
    //         title: 'Warning',
    //         text: 'The following subjects exceed 240 minutes per week: ' + exceedSubjectNames,
    //     });
