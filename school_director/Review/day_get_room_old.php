...
if (isset($_POST['day'])) {
    ...
    $query = "SELECT classschedules.RoomID, rooms.RoomNumber, classschedules.Time_Start, classschedules.Time_End, sections.SectionName
              FROM classschedules 
              INNER JOIN rooms ON classschedules.RoomID = rooms.RoomID 
              INNER JOIN sections ON classschedules.SectionID = sections.SectionID
              WHERE classschedules.is_$day = 1 
              AND classschedules.Active = 2
