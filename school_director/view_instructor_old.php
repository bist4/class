                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 mb-3">
                                ...
                                <select id="instructor" class="form-control w-100" required>
                                    ...
                                    $sqlInstructor = "SELECT DISTINCT c.InstructorID, u.Fname, u.Lname 
                                                    FROM classschedule c
                                                    INNER JOIN userroles ur ON c.InstructorID = ur.UserRoleID
                                                    INNER JOIN userinfo u ON ur.UserID = u.UserInfoID
                                                    WHERE c.Active = 1
                                                   ";
